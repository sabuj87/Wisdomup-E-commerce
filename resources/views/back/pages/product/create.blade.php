            ...
            <div class="card card-primary">
                ...
                <form action="{{route('products.store')}}" method="POST"  enctype="multipart/form-data" >
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-lg-12">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="title" onkeyup="change(this)" class="form-control" id="category_name" required placeholder="Enter short title">
                            @if($errors->has('title'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="longtitle"  class="form-control" id="category_name"  placeholder="Enter long title">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="slug" name="slug" class="form-control" required placeholder="Enter slug title">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="price" class="form-control" id="category_name" required placeholder="Enter a price">
                          ...
                          <div class="form-group">
                            ...
                            <input type="number" name="quantity" class="form-control" id="quantity" required placeholder="Enter quantity">
                    ...
                    <div class="col-lg-12">
                       ...
                       <textarea  name="description" id="editor1" rows="5" style="width: 100%;" ></textarea>
                   ...
                   <textarea  name="specification" id="editor2" rows="3" style="width: 100%;" ></textarea>
                   ...
                   <div  class="col-lg-12">
                    <div class="whitebg radius5"  >
                       ...
                       <div class="input-group">
                        <div class="custom-file">
                          <input onchange="pimg6.src=window.URL.createObjectURL(this.files[0])" type="file" required name="thumb" class="custom-file-input" id="exampleInputFile">
                          <label class="custom-file-label" for="exampleInputFile">Choose Thumbnail</label>
                        </div>
                        <div class="input-group-append">
                          <span class="input-group-text">
                            <img id="pimg6" onerror="this.src='{{asset('image/other/default.png')}}'"   height="20px" width="20px" src="" alt="">
