                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6" >
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name"  value="{{$collection->name}}"  class="form-control" id="category_name" placeholder="Enter brand name">
                                    @if($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="description" value="{{$collection->description}}" class="form-control" id="description" placeholder="Description">
